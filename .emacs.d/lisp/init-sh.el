...
(defun dnixty/sh-set-indent-rules ()
  (setq sh-indent-for-case-label 0
        sh-indent-for-case-alt '+))

(defun dnixty/sh-set-prompt ()
  (set (make-local-variable 'defun-prompt-regexp)
       (concat "^\\(function[ \t]\\|[[:alnum:]_]+[ \t]+()[ \t]+\\)")))

;;; Hooks
(dolist (fun '(dnixty/sh-set-indent-rules dnixty/sh-set-prompt dnixty/sh-set-compiler))
  (add-hook 'sh-mode-hook fun))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(define-skeleton dnixty/sh-commands-or-die
...
(define-skeleton dnixty/sh-ifcommand
...
(define-skeleton dnixty/sh-while-getopts
...
(define-skeleton dnixty/sh-while-read
